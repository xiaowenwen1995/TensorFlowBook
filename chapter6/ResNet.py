# -*- coding: utf-8 -*-
"""
Created on Fri May 25 10:59:55 2018
...
#create a class named Block.
#scope: the name of this block
#unit_fn: Residual learning unit
#args: the args of block: (depth, depth_bottleneck, stride)
...
#define stack blocks function
#net: input data tensor
#blocks: class block list
#outputs_collections: the collection of end_points
@slim.add_arg_scope
...
#define the default value of arguments
#is_training: true
#weight_decay: the decay rate of weight: 0.0001
#batch_norm_decay: the decay rate of batch normalizer: 0.997
...
def resnet_arg_scope(is_training = True, weight_decay = 0.0001, batch_norm_decay = 0.997, batch_norm_epsilon = 1e-5, batch_norm_scale = True):
    ...
    #weights_regularizer: regularizer function :l2
    #weights_initializer: variance_scaling_initializer
    #activation_fn: activation function; ReLU
    #normalizer_fn: normalizer function: batch normalizer
    #normalizer_params: batch normalizer
...
#define residual learning unit
#use Batch Normalization and preactivation
#inputs: input dataset tensor
#depth, depth_bottleneck, stride
#outputs_collections: the collection of end_points
#scope: the name of this unit
@slim.add_arg_scope
def bottleneck(inputs, depth, depth_bottleneck, stride, outputs_collections = None, scope = None):
    with tf.variable_scope(scope, 'bottleneck_v2', [inputs]) as sc:
        #get the output cannel and the min rank is 4
        depth_in = slim.utils.last_dimension(inputs.get_shape(), min_rank = 4)
        #Batch Normalization an preaction: ReLU
...
#the main function of ResNet
#inputs: input dataset tensor
#blocks: class Block list
#num_class: the last number of class
#global_pool: average pool
#include_root_block: add 7x7 convolution and max pool
#reuse: if reuse
#scope: the name of net
